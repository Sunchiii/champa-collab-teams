<template>
    <div class="container font-sans m-auto pb-20 px-2 w-full">
        <div class="h-1/2">
            <div style="color:6190be" class="pb-4 pt-1 text-center tracking-0.1em text-sm font-bold text-blue-500">BRANDS</div>
            <div class="text-3xl font-bold pb-4">
                <div class="text-center">Get matched with the life insurance policy</div>
                <div class="text-center">that works best for you.</div>
            </div>
            <div class="text-center text-gray-500 center-text text-base pb-10">with a few basic questions, you can search and compare personalized quotes from top carriers.</div>
        </div>
